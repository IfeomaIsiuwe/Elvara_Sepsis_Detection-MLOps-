...
try: 
    ...
    from features_engineering import build_feature_matrix
except ImportError:
    from src.data_pipeline import load_raw_data, clean_data
    from features_engineering import build_feature_matrix

def train_and_eveluate_models(
    ...
    patients, vitals, labs, history, outcomes = clean_data(*load_raw_data())
